...
/* Iterate through the finances array to find the total ammount of profits/losses */
for (var i = 0; i < finances.length; i++) {
  totalProfits += finances[i][1];
}

/* Iterate through the finances array to find the difference of profits/losses from month to month */
for (var i = 0; i < finances.length - 1; i++) {
  var currentMonth = finances[i];
  var followingMonth = finances[i + 1];
